...
export const PopularResults: React.FC<Props> = ({
  itemList,
  onCopyPreview,
  onCopyFull,
  onOpenViewer,
  ...
  if (!itemList?.length)
    return (
      <div className="text-center py-12">
        <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-400 mb-2">인기글을 찾지 못했습니다</h3>
        <p className="text-gray-500 dark:text-gray-500">다른 키워드로 검색해보세요</p>
      </div>
    );
  ...
  return (
    <div className="space-y-8">
      {grouped.map(([group, list]) => (
        <section key={group} className="border border-gray-200 dark:border-gray-700 rounded-2xl p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 shadow-lg">
