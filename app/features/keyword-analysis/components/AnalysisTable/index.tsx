      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-border">
            <th className="text-left p-4 font-semibold text-text-secondary">키워드</th>
            <th className="text-center p-4 font-semibold text-text-secondary">점수</th>
            <th className="text-right p-4 font-semibold text-text-secondary">총검색량</th>
            <th className="text-right p-4 font-semibold text-text-secondary">PC</th>
            <th className="text-right p-4 font-semibold text-text-secondary">모바일</th>
            <th className="text-right p-4 font-semibold text-text-secondary">발행량</th>
            <th className="text-right p-4 font-semibold text-text-secondary">포화지수</th>
            <th className="text-center p-4 font-semibold text-text-secondary">경쟁</th>
            <th className="text-center p-4 font-semibold text-text-secondary">트렌드</th>
              ...
              >
                <td className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <Star
                        className={`w-4 h-4 ${
                          isFavorite(keyword) ? 'fill-yellow-400 text-yellow-400' : 'text-text-tertiary'
                        }`}
                      />
                    </button>
                    <div>
                ...
                <td className="p-4">
                  <a
                    ...
                    className="p-2 text-text-tertiary hover:text-primary hover:bg-hover rounded-lg transition-all inline-block"
                  >
