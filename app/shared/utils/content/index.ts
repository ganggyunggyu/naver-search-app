import { fetchHtml, NAVER_DESKTOP_HEADERS } from '@/shared/utils/http';
import { getIframeElement } from '@/shared/utils/get-iframe-element';
import { loadHtml } from '@/shared/utils/html';
import { normalizeImageSrc } from '@/shared/utils/images';
import { cleanText, isMeaningfulText } from '@/shared/utils/text';
